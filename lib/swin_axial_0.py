...
class Swin_axial(nn.Module):
    def __init__(self, inp, oup, scale_size):
        ...
        self.transformer1 = Transformer(inp, oup, (12 * self.scale_size, 12 * self.scale_size ))
        self.transformer2 = Transformer(inp, oup,  (12 * self.scale_size , 12 * self.scale_size ))
        self.transformer3 = Transformer(inp, oup,  (12 * self.scale_size , 12 * self.scale_size ))
        self.transformer4 = Transformer(inp, oup,  (12 * self.scale_size , 12 * self.scale_size ))
        ...
        self.hight_block = AxialAttention(inp, oup, groups=4, kernel_size=12 * self.scale_size)
        self.width_block = AxialAttention(inp, oup, groups=4, kernel_size=12 * self.scale_size, stride=1,width=True)
        self.diagonal_block3 = AxialAttention(inp, oup, groups=4, kernel_size=24 * self.scale_size, stride=1)     # 大主
        self.diagonal_block4 = AxialAttention(inp, oup, groups=4, kernel_size=24 * self.scale_size + 1, stride=1) # 大副

        self.hight_block1 = AxialAttention(inp, inp, groups=4, kernel_size=24 * self.scale_size)
